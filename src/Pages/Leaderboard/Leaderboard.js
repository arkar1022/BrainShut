    ...
    <>
      <Box mx={4} mt={7} sx={{ flexGrow: 1 }}>
        <Grid container spacing={0}>
          <Grid item xs={12} md={8} lg={6} className="gridLeft">
            <RLink to={"/home"}>
              <ArrowIcon icon={faArrowLeft} />
            </RLink>
            <STitle>Leaderboard</STitle>
          </Grid>
          <Grid item xs={12} md={4} lg={6} className="gridLeft">
            <SeasonTxt>Season - 1 Autumn</SeasonTxt>
          </Grid>
              ...
              {data.map((row) => {
                return [
                  <Row container my={1} rowSpacing={1}>
                    <Grid item xs={1} md={2} className="gridACenter">
                      {row.id}
                    </Grid>
                    <Grid item xs={2} md={3} className="gridLeft">
                      {row.name}
                    </Grid>
                    ...
                    <Grid item xs={2} md={2} className="gridLeft">
                      {" "}
                      {row.totalScore}
                    </Grid>
                  </Row>,
